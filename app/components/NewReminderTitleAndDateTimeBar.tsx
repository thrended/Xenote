...
interface NewReminderTitleAndDateTimeBarProps {
  reminder: Reminder;
  updateTitleCallback: (reminder: Reminder, _title?: string ) => void;
  UpdatetimeanddateCallback: (reminder: Reminder, _scheduledDatetime: Date) => void;
}
function NewReminderTitleAndDateTimeBar({
  reminder: reminder,
  updateTitleCallback,
  UpdatetimeanddateCallback,
  ...
  const onChange = (event, selectedDate) => {
    ...
    setShow(false);
    setDate(currentDate);
    UpdatetimeanddateCallback(reminder, currentDate)
